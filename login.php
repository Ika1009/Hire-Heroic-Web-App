...
<html>
    <head>
        ...
        <title>Login</title>
        <link rel="icon" href="images/UltraCv.png" type="image/x-icon">
    ...
    <body>
        <div class="lg:flex">
            ...
            <div class="lg:pt-8 bg-background-100 lg:bg-white flex justify-center lg:justify-center lg:px-12">
                    ...
                    <div class="mt-12">
                        <form>
                            <div>
                                ...
                                <input name="email" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-secondary-300" type="email" id="name_input" placeholder="mike@gmail.com">
                            </div>
                            <div class="mt-8">
                                ...
                                <input name="password" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-secondary-300" type="password" id="password_input" placeholder="Enter your password">
                            </div>
                            <div class="mt-10">
                                <button type="submit" class="bg-primary-300 text-text-800 p-4 w-full rounded-full tracking-wide font-semibold font-display focus:outline-none focus:shadow-outline hover:bg-primary-400 shadow-lg">
                                    Log In
                                </button>
                            </div>
                        </form>
            ...
            <div class="hidden lg:flex items-center justify-center bg-background-100 flex-1 h-screen">
                <div class="max-w-xs transform duration-200 hover:scale-110 cursor-pointer">
                    <svg class="w-5/6 mx-auto" xmlns="http://www.w3.org/2000/svg" id="f080dbb7-9b2b-439b-a118-60b91c514f72" data-name="Layer 1" viewBox="0 0 528.71721 699.76785">
                        ...
                        <polygon points="337 691.063 317.217 691 318 0.063 337 0.063 337 691.063" fill="#f89f3a"/>
                        <g opacity="0.1">
                        ...
                        <path d="M735.8586,266.93948s-13,0-16,18-6,78-6,78-42,55-35,62,15,20,20,18,48-61,48-61Z" transform="translate(-335.6414 -100.11607)" fill="#fab76b"/>
                        ...
                        <path d="M820.3586,253.43948l-10.5,10.5s-32,12-47,0c0,0,5.5-11.5,5.5-10.5s-43.5,7.5-47.5,25.5,3,49,3,49-28,132-17,135,114,28,113,9,8-97,8-97l35-67s-5-22-17-29S820.3586,253.43948,820.3586,253.43948Z" transform="translate(-335.6414 -100.11607)" fill="#fab76b"/>
